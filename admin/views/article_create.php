...
<li><?php echo form_label('设置:');?><?php echo form_checkbox('auto',400,'checked');?> 是否获取内容200字为描述内容？

</li>
<li>
    <!-- 加载编辑器的容器 -->
    <label>内容:</label><script id="editor" name="contents" type="text/plain" style="width:980px;height:300px;"></script>
</li>
